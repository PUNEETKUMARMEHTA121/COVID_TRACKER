...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        worldCasesTV = idTVWorldCases
        worldRecoveredTV = idTVWorldRecovered
        worldDeathsTV = idTVWorldDeaths
        countryCasesTV = idTVIndiaCases
        countryDeathsTV = idTVIndiaDeaths
        countryRecoveredTV = idTVIndiaRecovered
        stateRV = idRVStates
